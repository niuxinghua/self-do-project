              ...
              sureButtonTitle:(NSString *)sureTitle
{
    if (self = [super init]) {
        ...
        _iconImageView = [[UIImageView alloc]initWithFrame:CGRectMake(0, 15, 30, 30)];
        _iconImageView.image = [UIImage imageNamed:@"alerticon"];
        ...
        UILabel *detailTitleLab = [self lableWithFont:13];
        detailTitleLab.textColor = [UIColor colorwithHexString:@"#aaaaaa"];
        ...
        [detailTitleLab mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.centerX.equalTo(subTitleLab);
