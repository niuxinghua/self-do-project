//
//  XJHPostLostListViewController.m
//  caxjh
//
...
@interface XJHPostLostListViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation XJHPostLostListViewController
...
- (void)getData{
    ...
    [LostDataController getLostArticleDataFromStart:[NSString stringWithFormat:@"%d",_start] OnSuccess:^(id response) {
