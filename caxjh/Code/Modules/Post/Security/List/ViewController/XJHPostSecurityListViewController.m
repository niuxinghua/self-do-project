//
//  XJHPostSecurityListViewController.m
//  caxjh
//
...
@interface XJHPostSecurityListViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation XJHPostSecurityListViewController
...
- (void)getData{
    ...
    [SafetyDataController getSafetyArticleDataFromStart:[NSString stringWithFormat:@"%d",_start] OnSuccess:^(id response) {
