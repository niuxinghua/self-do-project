...
@interface XJHDonateViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation XJHDonateViewController
...
- (void)getData{
    ...
    [DonateDataController getDonateArticleDataFromStart:[NSString stringWithFormat:@"%d",_start] OnSuccess:^(id response) {
