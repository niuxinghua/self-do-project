...
- (void)initView
{
    ...
    self.layer.borderColor = [UIColor colorWithRed:67/255.0 green:80/255.0 blue:38/255.0 alpha:1.0].CGColor;
...
- (UIButton *)cancelButton
{
    if (!_cancelButton)
    {
        ...
        [_cancelButton setTitle:[kMultiTool getMultiLanByKey:@"cancell"] forState:UIControlStateNormal];
