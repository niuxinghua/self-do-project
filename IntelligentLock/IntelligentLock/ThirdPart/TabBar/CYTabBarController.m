...
- (void)setNewMessageBarIcon
{
    [[NSUserDefaults standardUserDefaults] setBool:YES forKey:@"hasmsg"];
    [[NSUserDefaults standardUserDefaults] synchronize];
    

    UIButton *messageTabbtn = _tabbar.btnArr[2];
    [messageTabbtn setImage:[[UIImage imageNamed:@"xiaoxi_new"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] forState:UIControlStateNormal];
    
//    _tabbar.items = self.items;
}
- (void)setDefaultMessageBarIcon
{
    [[NSUserDefaults standardUserDefaults] setBool:NO forKey:@"hasmsg"];
    [[NSUserDefaults standardUserDefaults] synchronize];
    

//    UITabBarItem *messageTab = self.items[3];
//    messageTab.image = [[UIImage imageNamed:@"message"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    UIButton *messageTabbtn = _tabbar.btnArr[2];
    [messageTabbtn setImage:[[UIImage imageNamed:@"message"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] forState:UIControlStateNormal];
}
