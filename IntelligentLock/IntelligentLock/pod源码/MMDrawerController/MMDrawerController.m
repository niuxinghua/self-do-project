...
- (void)viewDidLoad {
    ...
    [self setCloseDrawerGestureModeMask:MMCloseDrawerGestureModePanningDrawerView];
    
    self.title = [kMultiTool getMultiLanByKey:@"home"];
    
    UIBarButtonItem *buttonItem = [[UIBarButtonItem alloc]initWithImage:[[UIImage imageNamed:@"menu"]imageWithRenderingMode:
                                   
                                   UIImageRenderingModeAlwaysOriginal] style:UIBarButtonItemStylePlain target:self action:@selector(leftTouch)];
    self.navigationItem.leftBarButtonItem = buttonItem;
    
    UIBarButtonItem *rightbuttonItem = [[UIBarButtonItem alloc]initWithImage:[[UIImage imageNamed:@"setting-1"]imageWithRenderingMode:
                                                                         
                                                                         UIImageRenderingModeAlwaysOriginal] style:UIBarButtonItemStylePlain target:self action:@selector(rightTouch)];
...
- (void)leftTouch
{
     [[NSNotificationCenter defaultCenter] postNotificationName:@"searchdismiss" object:nil];
...
- (void)rightTouch
{
    SysSettingViewController *set = [[SysSettingViewController alloc]init];
